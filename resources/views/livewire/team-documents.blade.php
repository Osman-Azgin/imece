            ...
            <div class="w-full flex items-center justify-center">
                <div class="md:w-3/4 w-full bg-white p-3 rounded-lg drop-shadow-2xl grid grid-cols-5 gap-2 mb-2">
                    ...
                    <div class="col-span-1 flex items-center justify-end pr-3">
                        <button type="button" class="p-2 rounded-full hover:bg-gray-100" wire:click="promptRemoveDocument({{ $document->id }},'{{ $document->filename }}')">
                            <svg style="width: 26px;height:26px;color: red;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
