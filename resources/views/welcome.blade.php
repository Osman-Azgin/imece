    ...
    <div class="p-6 lg:p-8">
        ...
        <div class="mt-6" style="min-height: 60vh;">
            @foreach($currentRequirements as $requirement)
                <div class="w-full p-6 grid grid-cols-4 md:grid-cols-5 gap-4 md:gap-2 bg-white rounded-lg items-center justify-center mb-6">
                    <div class="flex items-center justify-start h-full col-span-2">
                        <svg style="width: 30px;height:30px;color:purple;margin-right: 15px;"
                    ...
                    <div class="flex items-center justify-start h-full col-span-2 md:col-span-1">
                    ...
                    <div class="flex justify-between md:justify-end h-full col-span-4 md:col-span-2">
                        <div>
                            {{ $requirement->warehouse->address->street->name }}
